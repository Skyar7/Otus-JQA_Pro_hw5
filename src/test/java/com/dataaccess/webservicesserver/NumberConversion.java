 ...
 * 2024-04-04T19:44:16.544+07:00
 * Generated source version: 3.3.4
 *
 */
@WebServiceClient(name = "NumberConversion",
                  wsdlLocation = "file:/E:/IdeaProjects/Otus-JQA_Pro_hw5/src/test/resources/wsdl/numberconversion.wsdl",
...
public class NumberConversion extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/E:/IdeaProjects/Otus-JQA_Pro_hw5/src/test/resources/wsdl/numberconversion.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(NumberConversion.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/E:/IdeaProjects/Otus-JQA_Pro_hw5/src/test/resources/wsdl/numberconversion.wsdl");
        }
        WSDL_LOCATION = url;
    }
